...
public class PedidoService {
    ...
    public Map<Integer, Solicitante> sgbdInit() {
        ...
        Solicitante solicitante2 = new Solicitante("Ana", "2222222222222", "ana@teste2.com");
//mudei de float para double e long
        Sobremesa sobremesa = new Sobremesa("Sorvete De Chocolate",30.5f,10,10f,true,"Sorvete muito gostoso");
